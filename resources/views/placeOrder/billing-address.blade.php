                  ...
                  <tbody>
                    ...
                    <tr>
                      <td style="width: 50%;">
                          ...
                          <input type="hidden" name="customer_id" value="{{ $in->id }}">
                          <input type="text" name="fname" class="form-control" value="{{ $in->fname }}" required>
                      </td>
                      <td style="width: 50%;"> 
                          <label>Last Name</label>
                          <input type="text" name="lname" class="form-control" value="{{ $in->lname }}" required>
                      </td>
                    </tr>
                    <tr>
                      <td style="width: 50%;">
                          ...
                          <select class="form-control" name="nationality" id="nationality" required>
                              <option value="{{ $in->nationality }}"> {{ $in->nationality }} </option>
                    ...
                    <tr>
                      <td style="width: 50%;"> 
                          ...
                          <input type="text" name="address" class="form-control" value="{{ $in->address }}" required>
                      </td>
                      <td style="width: 50%;">
                          <label>Email</label>
                          <input type="text" name="email" class="form-control" value="{{ $in->email }}" required>
                      </td>
                    </tr>
                    @endforeach
                   </tbody> 
